...
///         ⚠
///         <b>
///             This is the suite the build's second clause was written for, and it was the one
///             suite the convention's test did not reach.
///         </b> On 2026-09-17 this assembly passed with
...
public sealed class BundleSkipConventionTests {
    ...
    public void TheEmptyClusterFixtureSkipNamesItsPrerequisites() =>
        new EmptyClusterFixture().Skip(BundleInstaller.CertManagerComponent, "some-row", "nothing")
            .ShouldContain(
    ...
    public void TheStoryFixtureSkipNamesItsPrerequisites() =>
        new M1StoryClusterFixture().Skip("nothing")
            .ShouldContain(
                ClusterInfrastructure.PrerequisiteMarker,
                Case.Sensitive,
    ...
    public void TheDaemonFreeSkipNamesItsPrerequisite() =>
        BundleInstaller.SkipWithoutBash("install.sh", "nothing")
            .ShouldContain(
                ClusterInfrastructure.PrerequisiteMarker,
                Case.Sensitive,
