...
// repair, as CyberCloud.ResourceManager/GlobalUsings.cs. Orleans ships a PUBLIC `Orleans.ErrorCode`
// and the Orleans SDK adds `global using Orleans;`, so any file that also imports CyberCloud.Core has
// two candidates for the simple name and the compiler reports CS0104.
