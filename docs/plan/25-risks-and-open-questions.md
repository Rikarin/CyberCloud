...
|---|---|---|---|
| 1 | **Public DNS: run it or wholesale it?** ([14](14-networking.md)) | Phase 2 network work, infrastructure plan | Run it — but the anycast/PoP cost lands in infra, not engineering |
| 2 | **Abuse desk: staffed?** ([17](17-communication-and-email.md)) | Whether Mail is built | Cut Mail from M2 to M3 |
...
| 5 | **Do we depend on `Azure.Core` in our SDK?** ([21](21-cli-and-sdks.md)) | SDK design | Yes — MIT, excellent, and the mental model transfers |
