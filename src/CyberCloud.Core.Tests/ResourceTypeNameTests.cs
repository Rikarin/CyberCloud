...
public class ResourceTypeNameTests
{
    ...
    {
        var count = 0;
        using var namespaces = Corpus.ValidNamespaces(2_000, seed: 11).GetEnumerator();
        using var typePaths = Corpus.ValidTypePaths(2_000, seed: 12).GetEnumerator();
    ...
    public void MalformedPartsAreRejected(string? providerNamespace, string? typePath)
    {
        ...
        Should.Throw<ArgumentException>(
            () => new ResourceTypeName(providerNamespace!, typePath!));
    }
    ...
    public void ASegmentLongerThanSixtyThreeCharactersIsRejected()
    {
        ...
        ResourceTypeName.Create("CyberCloud.Data", new string('a', 63)).IsSuccess.ShouldBeTrue();
    }
