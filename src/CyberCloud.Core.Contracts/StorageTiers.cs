...
/// <summary>
///     The names of the two grain-storage providers. ADR-003 (docs/plan/02:167-198) and
///     docs/plan/05 § The two tiers.
/// </summary>
/// <remarks>
///     <para>
///         These strings are the ones in <c>[PersistentState("state", StorageTiers.Hot)]</c>
///         (docs/plan/02:172-173) and in <c>AddMultitenantGrainStorage…(StorageTiers.Durable, …)</c>
