...
/// </summary>
/// <remarks>
///     ⚠ <b>The assertion the task set is "the stagger actually spreads re-establishment rather than
///     being a constant", and that is what the distribution tests below check.</b> It is an easy
...
public sealed class InformerStaggerTests
{
    ...
    public void ItIsNotAConstant()
    {
        ...
        delays.Distinct().Count().ShouldBeGreaterThan(
            25,
    ...
    public void DifferentClustersGetDifferentSlotsEvenWhenTheirIdsAreAdjacent()
    {
        ...
        Math.Abs(a - b).ShouldBeGreaterThan(
            0.01,
