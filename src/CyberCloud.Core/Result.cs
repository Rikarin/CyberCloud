...
/// <remarks>
///     <para>
///         docs/plan/00:170-173: <i>"Every grain interface method returns <c>Task&lt;Result&lt;T&gt;&gt;</c>
...
///         exception maps to <c>500</c> and pages someone."</i>
///     </para>
///     <para>
...
public readonly record struct Result
{
    ...
    public static Result Failure(ErrorCode code, string message, string? target = null) =>
        Failure(new Error(code, message, target));
    ...
    public T GetValueOrThrow() =>
        IsSuccess && held is not null
            ...
            : throw new InvalidOperationException(
                $"Result<{typeof(T).Name}> has no value: {Error}");
