...
public sealed class CommunicationDeclarationTests {
    ...
    sealed class RefusingPlane : ICommunicationControlPlane {
        ...
        public Task<Result<SuppressionEntry>> SuppressAsync(Guid tenantId, Guid serviceId, ChannelKind channel, string destination, SuppressionReason reason, string note, Guid ownerResourceId, CancellationToken cancellationToken = default) => throw new NotSupportedException();
