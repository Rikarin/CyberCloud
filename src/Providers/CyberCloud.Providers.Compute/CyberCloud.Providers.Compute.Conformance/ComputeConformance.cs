...
public sealed class VirtualMachineCase : IProviderCaseSource {
    ...
    public static ProviderConformanceCase ProviderCase { get; } =
        new() {
            ...
            DataPlane = null,
            StoragePrefix = null,
            // The power actions read the VirtualMachine the reconciler applied and nothing an
            // operator writes. Stated rather than defaulted — see ProviderConformanceCase.OperatorWritten.
