...
public sealed class ClickHouseReconcilerTests {
    ...
    public void TheStructuralCheckStillMissesAReadonlyMutableCache() {
        ...
        // somebody adds one for performance. THREE providers have confirmed that only the cross-tenant
        // test below catches it; this is the fourth, and pinning it is what stops the next test looking
        // redundant.
        //
