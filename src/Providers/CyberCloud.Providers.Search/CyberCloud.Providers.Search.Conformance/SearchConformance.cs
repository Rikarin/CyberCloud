...
///             held.
///         </b> What this one adds is a body whose rendered object contains an
///         <b>
///             array the
///             provider owns wholesale
///         </b> — <c>spec.nodePools</c>. Every earlier case's rendered spec is a
...
///         ⚠
///         <b>
///             <see cref="ProviderConformanceCase.Objects" /> is one <c>OpenSearchCluster</c> and that
///             is not an under-declaration.
///         </b> The three StatefulSets, their Services, the generated TLS
...
///         ⚠
///         <b>
///             <see cref="ProviderConformanceCase.ChangedBody" /> moves
///             <c>coordinatingNodes</c> rather than <c>dataNodes</c>, and the choice is the opposite of the
///             one <c>StorageCase</c> makes for its own reason.
///         </b> That case picks the property carried in
...
///         ⚠
///         <b>
///             <see cref="ProviderConformanceCase.Body" /> IS THE SMALLEST LEGAL SERVICE AND NOT THE
///             SCHEMA'S OWN DEFAULT, AND THE REASON IS A PROPERTY OF THE HARNESS THAT NO EARLIER PROVIDER
///             HAD REACHED.
///         </b> The suite shares <b>one subscription</b> across every create it makes and
...
///             ⚠
///             <b>
///                 The failure names quota and not the provider, which is what makes it worth writing
///                 down rather than just fixing.
///             </b> A provider author meeting it sees a subscription limit
