...
public sealed class OpenSearchReconcilerTests {
    ...
    public void TheStructuralCheckCatchesAReadonlyMutableCache() {
        ...
        //
        // ⚠ THE TEMPTATION WAS LARGEST ON THIS TYPE. ClusterJson renders a three-entry array by
        // re-reading the body and re-resolving the preset table on every pass, which is precisely
        // the shape somebody memoises.
        //
