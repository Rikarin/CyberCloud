...
///     </para>
///     <para>
///         ⚠ <b>No <c>SupportsSoftDelete</c>, for the reason the five providers before this one
///         give</b>: nothing in the manager reads <c>SoftDeleteDays</c>, and declaring a recovery window
///         the platform does not honour would be a promise made to the users most likely to test it.
///     </para>
///     <para>
