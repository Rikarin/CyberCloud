...
public sealed class KafkaCase : IProviderCaseSource {
    ...
    public static ProviderConformanceCase ProviderCase { get; } =
        new() {
            ...
            CreateReconciler = static clock => new KafkaClusterReconciler(clock),
            Type = KafkaClusters.Type,
            ApiVersion = KafkaClusters.V2026,
            Body = static cluster => KafkaClusters.Body(cluster),
            ...
            ChangedBody = static cluster => KafkaClusters.Body(cluster, 5),
            ...
            InvalidBody = static cluster => WithoutStorageSize(KafkaClusters.Body(cluster)),
