...
///         ⚠
///         <b>
///             Two class declarations, and that is the entire cost of putting a SECOND type in this
///             namespace under the cluster-backed suite.
///         </b> The case is <see cref="NatsCase" /> — the
...
///         ⚠
///         <b>
///             This is the first case in the tree whose objects are MOSTLY not custom resources, and
///             it is the counter-measurement to the one this project's header records.
///         </b> That header
