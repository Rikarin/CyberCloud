...
///         <c>ClusterConformanceHarness</c>, which derives them. A readiness gate written against a world
...
public sealed class KafkaClusterReconciler(IClock clock) : IResourceReconciler {
    ...
    static async Task<ReconcileOutcome?> Apply(
        ...
        if (applied.TryGetError(out var applyError)) {
            ...
            // Strimzi CRD the operator never installed, our own credentials — will be refused
