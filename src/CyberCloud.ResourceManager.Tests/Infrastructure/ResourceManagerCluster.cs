    ...
    sealed class SiloConfigurator : ISiloConfigurator {
        public void Configure(ISiloBuilder silo) {
            ...
            silo.ConfigureServices(services => {
                    ...
                    // The handlers a relayed action runs on this silo — ClusterActionRelayTests. The
                    // clone is the one that creates as its caller, through the creator the silo builds.
                    services.AddSingleton<RestartHandler>();
                    services.AddSingleton<CloneHandler>();
