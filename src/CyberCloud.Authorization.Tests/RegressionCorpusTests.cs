...
public sealed class RegressionCorpusTests {
    ...
    public void EveryCaseIsWellFormed() {
        ...
        foreach (var corpusCase in RegressionCorpus.Cases) {
            corpusCase.Why.Length.ShouldBeGreaterThan(60, $"{corpusCase.Name} does not say what went wrong");
            ...
            foreach (var expectation in corpusCase.Expectations) {
                ...
                SubjectRef.Parse(expectation.Subject)
                    .IsSuccess.ShouldBeTrue($"{corpusCase.Name}: '{expectation.Subject}'");
...
///     ⚠
///     <b>
///         The second layer is the point of the corpus being a data structure rather than a pile of
///         test methods.
///     </b>
///     The in-memory run tests the evaluator; this one tests everything between a
