...
public sealed partial class PostgreSQLServerData {
    ...
    public sealed partial class PropertiesData {
        ...
        public sealed partial class RestoreData {
            ...
            /// <summary>A completed recovery point of a server in this resource group, as a backup vault's listRecoveryPoints names it. Empty means a new, empty database. Set at creation: a restore always creates a new server and never writes into one.</summary>
            /// <remarks>⚠ Cannot change after create. Defaults to "" when left unset.</remarks>
