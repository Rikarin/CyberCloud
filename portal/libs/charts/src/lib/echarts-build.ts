 ...
 *
 * ⚠ **Measured, 2026-09-24, minified and gzipped at level 9**: this set is 173.8 KB; with `LineChart`,
 * the full `GridComponent` and the scrolling legend it was 185.3 KB; the core and the canvas renderer
 * alone are 129.3 KB. No ECharts build fits the 120 KB route budget, which is why the library has a
 * ceiling of its own (docs/plan/20 § Performance budget). Every addition here is paid for in it.
 *
