...
| Route                                                          | Page                 | Calls                                                                                                                                                                   |
| -------------------------------------------------------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/subscriptions`                                               | list + create        | `GET /tenants/{t}/subscriptions` through `ScopeCollections` (the scope collection, by hand until `libs/api` regenerates), then `createSubscription`                     |
